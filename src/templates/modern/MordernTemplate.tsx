      ...
      <div className="flex">
        ...
        <div className="basis-[40%] p-3">
          ...
          <SectionValidator value={resumeData.skills.languages}>
            <SkillsSection title="Keahlian dan kemampuan teknis" list={resumeData.skills.languages} />
          </SectionValidator>

          <SectionValidator value={resumeData.skills.technologies}>
            <SkillsSection title="Keterampilan / Eksposur" list={resumeData.skills.technologies} />
          </SectionValidator>

          <SectionValidator value={resumeData.skills.tools}>
            <SkillsSection title="Penguasaan Bahasa" list={resumeData.skills.tools} />
          </SectionValidator>
