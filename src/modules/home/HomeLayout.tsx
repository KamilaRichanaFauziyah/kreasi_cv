  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: [0, 1] }} className="scroll-smooth">
        ...
        <div className="flex-auto flex justify-between items-center ml-5">
          <NavBarActions>
            <Link href="/builder" passHref={true}>
              <StyledButton variant="text">Kreasi CV</StyledButton>
            </Link>
          </NavBarActions>
          <NavBarActions>
            <Link href="#about-us" passHref={true}>
              <StyledButton variant="text">Tentang kami</StyledButton>
            </Link>
            <a
              href={'https://github.com/KamilaRichanaFauziyah'}
              target="_blank"
        ...
        <div className="mx-6 md:mx-40 xl:mx-60 mb-6">
          ...
          >
            ...
            <div className="col-span-12 sm:col-span-8">
              ...
              <h1 className="text-5xl mb-12 text-resume-800">CURRICULUM VITAE</h1>

              <div className="flex mb-10">
                <div className="bg-resume-800 w-1 rounded-lg"></div>
                <p className="text-lg ml-3 text-resume-800">
                  &ldquo;Rahasia untuk maju adalah dengan memulai&rdquo;
                  <br />
                  —Mark Twain
                </p>
              </div>
        ...
        >
          <div className="grid grid-cols-12 items-center text-center">
            <div className="col-span-12 lg:col-span-4 mb-4 lg:mb-0 flex flex-col items-center gap-2">
              <Image src={'/icons/magic.svg'} alt="logo" height="48" width="48" />
              <p className="text-resume-800 text-xl mt-2">
                Ingin membangun <strong>personal branding?</strong>
              </p>
            </div>
            ...
            <div className="col-span-12 lg:col-span-2 flex flex-col items-center gap-2">
              ...
              <p className="text-resume-800 text-xl mt-2">
                Anda membutuhkan <strong>CV</strong> yang menarik?
              </p>
            </div>
      ...
      <div
        ...
        style={{ fontFamily: "'Roboto Slab', serif" }}
      >
        <h2 className="text-resume-800 text-3xl mb-2 text-center lg:text-left">Tentang kami</h2>
