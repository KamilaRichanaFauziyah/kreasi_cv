    ...
    <>
      <FeatureCard>
        ...
        <p className="text-xl mr-14">
          Sesuaikan dengan <strong>template dan warna tema</strong>!
        </p>
      </FeatureCard>
      ...
      <FeatureCard>
        ...
        <p className="text-xl mr-14">
          <strong>Antarmuka sederhana</strong> yang membantu Anda membangun CV dengan cepat!
        </p>
      </FeatureCard>
      ...
      <FeatureCard>
        ...
        <p className="text-xl mr-14">
        <strong>Tidak perlu mendaftar</strong> langsung membuat!
        </p>
      </FeatureCard>
      ...
      <FeatureCard>
        ...
        <p className="text-xl mr-14">
          <strong>Data Anda</strong> akan selalu tersimpab di perangkat Anda
        </p>
      </FeatureCard>
    </>
  );
